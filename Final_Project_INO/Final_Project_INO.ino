...
void check_schedule(){
      ...
      if(use_schedule){
           //nexLoop(nex_listen_list);
          if(schedules_water_start.compareTo(format_current_time(the_time))==0){
                relay.turn_on_channel(3);
                 //nexLoop(nex_listen_list);
          }
          else if(schedules_water_end.compareTo(format_current_time(the_time))==0){
                relay.turn_off_channel(3);
                 //nexLoop(nex_listen_list);
          }
          else if(schedules_air_start.compareTo(format_current_time(the_time))==0){
                relay.turn_on_channel(2);
                 //nexLoop(nex_listen_list);
          }
          else if(schedules_air_end.compareTo(format_current_time(the_time))==0){
                relay.turn_off_channel(2);
                 //nexLoop(nex_listen_list);
          }
          else if(schedules_light_start.compareTo(format_current_time(the_time))==0){
                relay.turn_on_channel(1);
                 //nexLoop(nex_listen_list);
          }
          else if(schedules_light_end.compareTo(format_current_time(the_time))==0){
                relay.turn_off_channel(1);
                 //nexLoop(nex_listen_list);
          }
      }
...
/*
String scheduled_time = format_scheduled_time(sched);

String current_time = format_current_time(THE_time);
...
Serial.print(scheduled_time.compareTo(current_time));
*/

String format_scheduled_time(String buf){
...
String format_current_time(String buf){
 ...
 hour_str = buf.substring(0,buf.indexOf(":"));
 mins_str = buf.substring(buf.indexOf(":")+1);
 mins_str = mins_str.substring(0,mins_str.indexOf(":"));
